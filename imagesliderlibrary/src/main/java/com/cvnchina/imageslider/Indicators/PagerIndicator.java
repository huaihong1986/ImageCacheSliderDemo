package com.cvnchina.imageslider.Indicators;
...
import com.cvnchina.imageslider.R;
...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener
{
	...
	public void setDefaultSelectedPadding(float left, float top, float right, float bottom, Unit unit)
	{
		if (unit == Unit.DP)
		{
			mSelectedLayerDrawable.setLayerInset(0, (int) pxFromDp(left), (int) pxFromDp(top), (int) pxFromDp(right), (int) pxFromDp(bottom));
		} else
		{
	...
	public void setDefaultUnSelectedPadding(float left, float top, float right, float bottom, Unit unit)
	{
		if (unit == Unit.DP)
		{
			mUnSelectedLayerDrawable.setLayerInset(0, (int) pxFromDp(left), (int) pxFromDp(top), (int) pxFromDp(right), (int) pxFromDp(bottom));
